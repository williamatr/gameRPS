...
function game(opcion_jugador, opcion_pc) {
  ...
  if (
    ...
    document.getElementById("textResult").innerText = "¡U WIN!";
    ...
    document.getElementById("textResult").innerText = "¡JOIN! ¿WTF?";
  } else {
    //alert("pc gana");
    ...
    document.getElementById("textResult").innerText = "¡U LOSE!";
